...
import com.sinyuk.fanfou.customtabs.client.CustomTabsHelper
import com.sinyuk.fanfou.customtabs.client.ServiceConnection
import com.sinyuk.fanfou.customtabs.client.ServiceConnectionCallback
...
class CustomTabActivityHelper : ServiceConnectionCallback {
    ...
    companion object {
        ...
        fun getIntent(context: Context, session: CustomTabsSession?): CustomTabsIntent {
            ...
            builder.setSecondaryToolbarColor(ContextCompat.getColor(context, R.color.itemBackground))
            val backIcon = BitmapFactory.decodeResource(context.resources, R.drawable.ic_back)
